...
public class StageHandler {
    ...
    public static int BALL_DIAMETER = 0;
    ...
    public void handleInput(char keyChar) {
        switch (currentStage) {
            case MAIN_SCREEN -> currentStage = Stage.SELECTION_SCREEN_ONE;
            case SELECTION_SCREEN_ONE -> {
                ...
                switch (keyChar) {
                    case '1' -> {
                        ...
                        pong.getObjects().add(new ComputerPlayer(LEFT_PADDLE_X, PADDLE_Y, PADDLE_HEIGHT, PADDLE_WIDTH, PADDLE_MOVEMENT_SPEED, pong.topInset, pong.getBaseWindowHeight() - PADDLE_HEIGHT));
                    }
                    case '2' -> {
                        /*
                         ...
                         */
                        currentStage = Stage.SELECTION_SCREEN_TWO;
                        pong.getObjects().add(new KeyboardPlayer(LEFT_PADDLE_X, PADDLE_Y, PADDLE_HEIGHT, PADDLE_WIDTH, LEFT_KEY_UP, LEFT_KEY_DOWN, PADDLE_MOVEMENT_SPEED, pong.topInset, pong.getBaseWindowHeight() - PADDLE_HEIGHT));
                        leftPlayer = true;
                    }
                    case '3' -> {
                        /*
                         ...
                         */
                        currentStage = Stage.SELECTION_SCREEN_TWO;
                        pong.getObjects().add(new WallPlayer(LEFT_PADDLE_X, pong.topInset, pong.getBaseWindowHeight(), PADDLE_WIDTH));
                    }
                }
            }
            case SELECTION_SCREEN_TWO -> {
                ...
                switch (keyChar) {
                    case '1' -> {
                        ...
                        pong.getObjects().add(new ComputerPlayer(RIGHT_PADDLE_X, PADDLE_Y, PADDLE_HEIGHT, PADDLE_WIDTH, PADDLE_MOVEMENT_SPEED, pong.topInset, pong.getBaseWindowHeight() - PADDLE_HEIGHT - pong.topInset));
                    }
                    case '2' -> {
                        /*
                         ...
                         */
                        currentStage = Stage.CONTROL_SCREEN;
                        pong.getObjects().add(new KeyboardPlayer(RIGHT_PADDLE_X, PADDLE_Y, PADDLE_HEIGHT, PADDLE_WIDTH, RIGHT_KEY_UP, RIGHT_KEY_DOWN, PADDLE_MOVEMENT_SPEED, pong.topInset, pong.getBaseWindowHeight() - PADDLE_HEIGHT));
                        rightPlayer = true;
                    }
                    case '3' -> {
                        /*
                         ...
                         */
                        currentStage = Stage.CONTROL_SCREEN;
                        pong.getObjects().add(new WallPlayer(RIGHT_PADDLE_X, 0, pong.getBaseWindowHeight(), PADDLE_WIDTH));
                    }
                }
            }
            case CONTROL_SCREEN -> {
                ...
                // Create a ball object with all the proper inputs.
                pong.getObjects().add(new Ball((pong.getBaseWindowWidth() / 2) - (BALL_DIAMETER / 2), (pong.getBaseWindowHeight() / 2) - (BALL_DIAMETER / 2), BALL_DIAMETER, BALL_SPEED, BALL_SPEED_INCREASE, pong.topInset, pong.getBaseWindowHeight(), pong.getBaseWindowWidth()));
            }
            /*
     ...
     */
    public enum Stage {
        MAIN_SCREEN, SELECTION_SCREEN_ONE, SELECTION_SCREEN_TWO, CONTROL_SCREEN, ACTIVE_GAME, PAUSE_MENU
    }
}
